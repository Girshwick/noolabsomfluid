 ...
 *
 * http://clipall.googlecode.com/svn-history/r16/trunk/ClipAll/src/dev/clipall/business/DefaultClipboardOwner.java
 *
 */
...
public class ClipBoardListener implements Runnable, ClipboardOwner {
        ...
        public static ClipBoardListener getInstance( String localName, ClipBoardIntf callinginstance, CBoardProperties cbProps){
                callingInstance = callinginstance;
                appRelativeLocalName = localName;
                return init(cbProps);
        }
       
        public static ClipBoardListener getInstance(ClipBoardIntf callinginstance, CBoardProperties cbProps){
                callingInstance = callinginstance;
                return init(cbProps);
        }

        public static ClipBoardListener getInstance(String localName, CBoardProperties cbProps){
        return init(cbProps);
    }
    ...
    private ClipBoardListener( ClipBoardIntf co  ){
        ...
        void processContents(Transferable t) throws UnsupportedFlavorException, IOException, Exception {
        ...
        if (t.isDataFlavorSupported(DataFlavor.stringFlavor)){
            ...
            //System.out.println("Processing: " + tr.getTransferData(DataFlavor.stringFlavor));
                ...
                if ((contentIsBufferedStr(cbStr)) && (cBoardProperties.isBlockIdenticalContent())){
                        return;
                ...
                // System.out.println("CB listener processing : " + t.toString().replace("sun.awt.datatransfer.", "") + "  -> " + cbStr);
        ...
        class RemovalTimer implements Runnable{
                ...
                public void run() {
                        ...
                        while ((removalIsScheduled) && (dT<timeOut) ){// && (clipListener.csv.alive)){
