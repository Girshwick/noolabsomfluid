...
import org.NooLab.stats.distribution.NormalDistribution;
...
public class MannWhitneyUTest {
    ...
    private double calculateAsymptoticPValue(final double Umin,
                                             final int n1,
                                             final int n2)
        throws ConvergenceException, Exception { // MaxCountExceededException
    ...
    public double mannWhitneyUTest(final double[] x, final double[] y)
        throws NullArgumentException, NoDataException,
        ConvergenceException, Exception { // MaxCountExceededException
