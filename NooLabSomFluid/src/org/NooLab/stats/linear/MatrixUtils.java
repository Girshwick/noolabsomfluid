...
import org.NooLab.stats.Field;
import org.NooLab.stats.FieldElement;
...
import org.NooLab.stats.exception.NoDataException;
...
import org.NooLab.stats.exception.ZeroException;
import org.NooLab.stats.fraction.BigFraction;
import org.NooLab.stats.fraction.Fraction;
import org.NooLab.stats.util.FastMath;
import org.NooLab.stats.util.Precision;
...
public class MatrixUtils {
    ...
    public static <T extends FieldElement<T>> FieldMatrix<T> createFieldMatrix(final Field<T> field,
                                                                               ...
                                                                               final int columns) {
        return (rows * columns <= 4096) ?
                // new Array2DRowRealMatrix<T>(field, rows, columns) : new BlockFieldMatrix<T>(field, rows, columns);
