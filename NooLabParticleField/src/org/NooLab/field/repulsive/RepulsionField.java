...
import org.NooLab.field.repulsive.components.ParticleAction;
...
public class RepulsionField implements 	Runnable, 
	...
	public boolean isReadyToUse () {
		return repulsionFieldFactory.isFacadeReadyToUse ;
	...
	public void onCalculationsCompleted() {
		...
		repulsionFieldFactory.isFacadeReadyToUse=true; // XXX will be set only HERE to true, after the first fixation 
	}
