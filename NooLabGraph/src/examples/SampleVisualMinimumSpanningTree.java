...
public class SampleVisualMinimumSpanningTree extends JFrame {
    ...
    public SampleVisualMinimumSpanningTree() throws Exception {
        ...
        vgraph.emphasizeSubGraph( subGraph,  null, null, null, newEdgePainter );
        ...
        // Initialise a layout manager, though not really part of this example
        ...
        Dimension frameSize = new Dimension( screenSize.width*2/3 - 80, screenSize.height*2/3 - 80 );
