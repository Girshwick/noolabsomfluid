...
public class ShortestPathDijkstraAlgorithm extends ShortestPathAlgorithm {
   ...
   */
  private WeightedGraphIntf shortestpathtree;
   ...
   */
  public ShortestPathDijkstraAlgorithm( WeightedGraphIntf wgraph, HeapNodeComparator comparator ) {
    super( wgraph );
   ...
   */
  public WeightedGraphIntf shortestPath( Vertex from ) {
    // clear the graph.
    // this.shortestpathtree.clear();
    this.shortestpathtree = new WeightedGraph();
