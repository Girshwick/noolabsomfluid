...
public class MinimumSpanningTreeKruskalAlgorithm extends MinimumSpanningTreeAlgorithm {
   ...
   */
  public MinimumSpanningTreeKruskalAlgorithm( WeightedGraphIntf wgraph ) {
    super( wgraph );
  }
  ...
  public WeightedGraphIntf minimumSpanningTree() {
    ...
    WeightedGraphIntf  spanningtree = new WeightedGraph();
    OpenJGraphIntf     spanningtestgraph = new OpenJGraph();
