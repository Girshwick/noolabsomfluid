...
public class TreeImpl extends OpenJGraph implements Tree {
    ...
    public Tree getSubTree( Vertex subTreeRootVertex ) throws Exception {
        ...
        EdgeIntf    edgeToParent = null;
        EdgeIntf    currentEdge;
        List    incidentEdges = this.getEdges( subTreeRootVertex );
        for( int i = 0; i < incidentEdges.size(); i++ ) {
            currentEdge = (EdgeIntf) incidentEdges.get( i );
        ...
        for( int i = 0; i < visited.size(); i++ ) {
            ...
            for( int j = 0; j < incidentEdges.size(); j++ ) {
                currentEdge = (EdgeIntf) incidentEdges.get( j );
