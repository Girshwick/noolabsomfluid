...
public class VisualVertex extends AbstractVisualGraphComponent {
  ...
  /**
   * Overrides the setFont() implementation by the AbstractVisualGraphComponent.
   * This simply calls super.setFont() and forces a rescaling of the
   * VisualGraphComponent based on the new font.
   *
   * @param   newfont   Font object that will now be used to draw the String
   *                    representation of the VisualVertex.
   */
