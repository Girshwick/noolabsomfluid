package org.NooLab.graph.visual.layout;
...
public interface GraphLayoutManager extends Serializable {
   ...
   *
   * @deprecated    This method is now replaced by <tt>routeEdge</tt>.
   ...
   * @param vedge   The VisualEdge object to be drawn
   *
   * @deprecated    This method is now replaced by <tt>alterEdgeGeneralPath</tt>.
   */
