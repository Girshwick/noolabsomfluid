...
import org.NooLab.graph.commons.GraphAddEdgeEvent;
import org.NooLab.graph.commons.GraphAddEdgeListener;
import org.NooLab.graph.commons.GraphAddVertexEvent;
import org.NooLab.graph.commons.GraphAddVertexListener;
import org.NooLab.graph.commons.GraphRemoveEdgeEvent;
import org.NooLab.graph.commons.GraphRemoveEdgeListener;
import org.NooLab.graph.commons.GraphRemoveVertexEvent;
import org.NooLab.graph.commons.GraphRemoveVertexListener;
 ...
 * @see         org.NooLab.graph.commons.OpenJGraphIntf
 */

public class VisualGraph implements
  GraphAddVertexListener, GraphAddEdgeListener,
  GraphRemoveVertexListener, GraphRemoveEdgeListener,
  Serializable {

  /**
   * The Graph object that the VisualGraph encapsulates.
   */
  private OpenJGraphIntf		graph;
  ...
  int     linetype = org.NooLab.graph.visual.VisualEdge.STRAIGHT_LINE;
  ...
  public void setGraph( OpenJGraphIntf graph ) {
    ...
    while( verticesiterator.hasNext() ){
      ...
      while( edgesiterator.hasNext() ){
        ...
        uniqueedges.add( (EdgeIntf) edgesiterator.next( ));
      }
    }
    ...
    while( edgesiterator.hasNext() ){
      visualEdges.add( new VisualEdge( (EdgeIntf) edgesiterator.next(), this ));
    }
  ...
  public void setOrthogonalLine(){
    this.setLinetype( org.NooLab.graph.visual.VisualEdge.ORTHOGONAL_LINE );
  }

  public void setStraightLine(){
    this.setLinetype( org.NooLab.graph.visual.VisualEdge.STRAIGHT_LINE );
  }
  ...
  public VisualEdge getVisualEdge( EdgeIntf edge ) {
    Iterator			iterator;
  ...
  public void setVisualEdge( EdgeIntf edge, VisualEdge newVisualEdge ) {
  ...
  public java.util.List translateToVisualEdges( java.util.List edges ) {
    ...
    for( i = 0;  i < size; i++ ) {
      translated.set( i, this.getVisualEdge( (EdgeIntf) translated.get( i )) );
    }
   ...
   * the subgraph.
   */
  public void emphasizeSubGraph( OpenJGraphIntf subGraph, VisualVertexPainter vPainter, VisualEdgePainter ePainter ) {
    ...
    while( vertexIterator.hasNext() ) {
        ...
        if( ePainter != null ) {
            ...
            while( edgeIterator.hasNext() ) {
                vedge = this.getVisualEdge( (EdgeIntf) edgeIterator.next() );
   ...
   */
  public void emphasizeSubGraph( OpenJGraphIntf subGraph,
