 ...
 * @see         org.NooLab.graph.visual.GraphScrollPane
 */
public class GraphPanel extends JPanel implements MouseListener, MouseMotionListener {
  ...
  GraphPanel(){
    ...
    state = new GraphPanelNormalState( this );
  ...
  /**
    ...
    *						resize GraphPanelSizeable
   */
  public void setGraph( OpenJGraphIntf g, GraphScrollPane gp ){
  ...
  public void setNormalMode() {
    this.state = new GraphPanelNormalState( this );
  }
  ...
  public void setVertexMode() {
    this.state = new GraphPanelVertexState( this );
  }
  ...
  public void setEdgeMode() {
    this.state = new GraphPanelEdgeState( this );
  }
