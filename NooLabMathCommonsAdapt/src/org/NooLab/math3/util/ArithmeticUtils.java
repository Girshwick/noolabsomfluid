...
import org.NooLab.math3.exception.Localizable;
...
public final class ArithmeticUtils {
     ...
     * @since 1.1
     */
    public static int addAndCheck(int x, int y) throws Exception {
        long s = (long)x + (long)y;
        if (s < Integer.MIN_VALUE || s > Integer.MAX_VALUE) {
            throw(new Exception(LocalizedFormats.OVERFLOW_IN_ADDITION +" "+ x+","+y));
        }
        return (int)s;
    }
    ...
    public static int pow(final int k, int e) {
        if (e < 0) {
            throw new NotPositiveException(e);
        }
