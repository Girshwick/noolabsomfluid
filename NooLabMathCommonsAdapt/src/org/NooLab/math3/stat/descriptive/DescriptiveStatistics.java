package org.NooLab.math3.stat.descriptive;
...
import org.NooLab.math3.exception.MathIllegalStateException;
...
import org.NooLab.math3.util.ResizableDoubleArray;
...
public class DescriptiveStatistics implements StatisticalSummary, Serializable {
    ...
    static MissingValueIntf missingValue = null;
    ...
    public static MissingValueIntf getMissingValue( ){
    	return missingValue;
    }
    ...
    public void activateMissingValues( boolean flag ){
    	missingValue.setActive(flag) ;
    }
    ...
    public void addValue(double v) {
		...
		if ((missingValue != null) && (missingValue.isActive())){
			consider = v != missingValue.getValue() ;
		}
		if (consider==false){
			return;
		}
    ...
    public void addValues(double[] values) {
    	...
    	for (int i=0;i<values.length;i++){
    		consider = true;
    		if ((missingValue != null) && (missingValue.isActive())){
    			consider = values[i] != missingValue.getValue() ;
    		}
    		if (consider){
    			addValue(values[i]) ;
    		}
    ...
    public void addValues( ArrayList<Double> values) {
    	...
    	for (int i=0;i<values.size();i++){
    		consider = true;
    		if ((missingValue != null) && (missingValue.isActive())){
    			consider = values.get(i) != missingValue.getValue() ;
    		}
    		if (consider){
